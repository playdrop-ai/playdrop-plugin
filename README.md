...
- `variants/antigravity/playdrop/`, `variants/grok/playdrop/`: native configuration candidates.
...
Development account/game reads passed with Codex 0.153.4, Claude Code 2.1.270 and Antigravity 1.2.7.
Grok Build 1.0.34 passed strict discovery with seven tools. These checks used programmatic PlayDrop fixture OAuth.
Native PlayDrop OAuth and full publishing acceptance in each provider remain separate release checks.
