...
Use this when creating a game art direction image from an idea, references, or a loose visual goal.

## Standard

Art direction is image-first. The output should feel like something a senior game art director could put in front of a team to align production and excite stakeholders.

Do not treat a written style guide, color list, wireframe, SVG diagram, or generic mood board as the finished result.

## Prompt Requirements

- start from the game idea, target platform, genre, and fantasy
...
- include avoid rules for common failure modes

## Sheet Layout By Platform

- mobile portrait: prefer a landscape image sheet with 3 to 4 portrait phone mockups in a horizontal row
- mobile landscape: prefer a portrait image sheet with 3 to 4 landscape phone mockups stacked vertically
- desktop or web: prefer a landscape image sheet unless a vertical editorial layout better shows progression
- the sheet layout should make every gameplay surface readable; do not force landscape HUDs into small side-by-side phones
- phone mockups should keep true device proportions and orientation
...
- generated images that only show mood and not the actual product surfaces
- vague prompts that could fit any game
- flat wireframes when the desired style is illustrated or premium casual
- mixing unrelated rendering styles
- hero art that does not match runtime
- raw screenshot crops as icon direction
