...
8. `playtest`: run `playdrop project check .` with focused-frame actions when input is needed, then fix broken controls, invisible entities, impossible goals, blank first frames, renderer failures, and console errors.
