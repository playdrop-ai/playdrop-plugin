# PlayDrop for Antigravity

Publish, test and share the browser games you build with Antigravity on PlayDrop. This plugin adds the
`playdrop-ai` skill and a connection to PlayDrop's remote MCP server. Sign in to your PlayDrop account when
Antigravity asks; there is no CLI or package to install.
