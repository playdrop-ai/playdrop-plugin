# PlayDrop for Grok Build

Publish, test and share the browser games you build with Grok Build on PlayDrop. This plugin adds the
`playdrop-ai` skill and a connection to PlayDrop's remote MCP server. Sign in to your PlayDrop account when
Grok Build asks; there is no CLI or package to install.
