...
1. Inspect 2 to 3 relevant Playdrop references with `playdrop search` and `playdrop detail`
2. Write the concept pitch, target player, best platform, and first-15-second hook
3. Confirm the concept is built on a proven core loop and has a real reason to exist beyond a skin or vibe shift
4. Define the GDD: loop, controls, progression, success and failure states
5. Define art direction, content strategy, and technical design
6. Produce a phased roadmap and identify the smallest slice worth building
