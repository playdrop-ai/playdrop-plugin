...
Follow `references/phases/remix-game.md`. If this is a worker task, also read `skills/task-worker/SKILL.md`.

## Rules

- Do not edit the source game in place.
- Scaffold with `./bin/playdrop project create app <slug> --remix <source-ref>` after claiming the new slug when the task requires it.
