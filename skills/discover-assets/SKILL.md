...
4. For 2D gameplay, start with `./bin/playdrop search "<genre>" --kind asset-pack --creator playdrop --pack-contains-category IMAGE --limit 10`.
5. For 3D gameplay, start with `./bin/playdrop search "<genre>" --kind asset-pack --creator playdrop --pack-contains-category MODEL_3D --limit 10`.
