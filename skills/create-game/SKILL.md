...
- Before scaffolding, choose the template, `design.assetStrategy`, and any core pack refs. After scaffolding, keep the scaffold structure and replace the sample loop with the game.
